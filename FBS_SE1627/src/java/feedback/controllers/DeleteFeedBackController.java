...
public class DeleteFeedBackController extends HttpServlet {
    ...
    private static final String ERROR = "MainController?action=ReadFeedBack";
    private static final String SUCCESS = "MainController?action=ReadFeedBack";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = dao.delete(feedbackID);
            if (check) {
                url = SUCCESS;
            }
