...
public class RemoCratContrroller extends HttpServlet {

    private static final String ERROR = "error.jsp";
    //private static final String SUS = "/FBS_SE1627/MainController?action=Payment&UserID=";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = dao.cartRemove(orderDetailID);
            if(check){
                dao.cartTrueRemove();
