...
public class PaymentController extends HttpServlet {
    ...
    private static final String ERROR = "/mainPage/user-services/Field-cart.jsp";
    private static final String SUS = "/mainPage/user-services/Field-cart.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (slotName.size() > 0) {
                request.setAttribute("CART", slotName);
                url = SUS;
            } else {
